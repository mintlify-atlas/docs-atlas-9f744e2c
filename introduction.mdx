...
description: "Lightweight SDL2 launcher for SM64 Coop Deluxe on Linux. Handles automatic game detection, ROM validation, mod management, profiles, and multiplayer setup."
---
