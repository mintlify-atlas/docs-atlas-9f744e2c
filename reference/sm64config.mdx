---
title: "sm64config.txt key reference"
sidebarTitle: "sm64config.txt"
description: "Reference for the sm64config.txt keys that the launcher reads and writes. Covers mod enable lines, DynOS pack lines, and network configuration fields."
---
...
- The `enable-mod:` prefix (with a trailing space and colon) is the canonical form. The launcher also accepts `enable-mod:` without a trailing space as a legacy variant.
