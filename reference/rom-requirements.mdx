---
title: "Super Mario 64 ROM requirements and validation"
sidebarTitle: "ROM Requirements"
description: "The launcher requires a Super Mario 64 (USA) ROM with MD5 20b854b239203baf6c961b850a4a51a2. It searches common locations automatically and copies the ROM to the save path."
---
...
Once a valid ROM is located the launcher copies it to `~/.local/share/sm64coopdx/baserom.us.z64` before spawning the game process. On subsequent launches, if that destination file already exists and its MD5 is valid, the copy step is skipped entirely — the launcher will not copy the file again.
