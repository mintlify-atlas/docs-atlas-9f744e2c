---
title: "How the launcher resolves the game binary path"
sidebarTitle: "Path Resolution"
description: "The launcher resolves the SM64 Coop DX binary through a 5-tier priority chain. Each level is validated; if the path doesn't exist the launcher falls through to the next tier."
---
