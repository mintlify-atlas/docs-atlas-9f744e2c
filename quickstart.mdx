---
title: "Get started with SM64 Coop DX Launcher"
sidebarTitle: "Quickstart"
description: "Launch SM64 Coop Deluxe in under 5 minutes: build the launcher, place your ROM, and run. The launcher auto-detects the game binary and validates your setup."
---
...
| 5 (default) | Automatic directory search | Scans `./`, `../`, and `~/sm64coopdx_Linux-*/` |
