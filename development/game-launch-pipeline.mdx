---
title: "Game launch pipeline: validation, ROM, and process spawn"
sidebarTitle: "Launch Pipeline"
description: "Step-by-step walkthrough of the coopdx-rs game launch: 500 ms fade, installation validation, ROM search and copy, CLI arg assembly, and process spawn."
---
...
The fade lasts exactly `FADE_DURATION_MS = 500 ms` (defined in `src/config.rs`). Once the 500 ms fade completes, the launcher proceeds immediately to validation and process spawn.
