---
title: "SM64 Coop DX Launcher architecture overview"
sidebarTitle: "Architecture"
description: "High-level architecture of coopdx-rs: the SDL2 event loop, application state machine, manager modules, UI system, and concurrency model for audio and game process monitoring."
---
